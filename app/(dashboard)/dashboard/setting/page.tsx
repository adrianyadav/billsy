    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage your practice information, user preferences, billing configuration, and security settings.
        </p>
      </div>
        ...
        <div className="col-span-2">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="practice-name" placeholder="Enter practice name" defaultValue="MediCare Clinic" />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="practice-address" placeholder="Enter practice address" defaultValue="123 Medical Center Dr, Suite 100" />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" type="email" placeholder="contact@practice.com" defaultValue="contact@medicare.com" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="npi" placeholder="1234567890" defaultValue="1234567890" />
                </div>
              </div>

              <Button className="w-full md:w-auto">Save Practice Information</Button>
            </CardContent>
          </Card>
            )}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Notifications for new invoices</p>
                    </div>
                    <Checkbox />
                  </div>
                  <div className="flex items-center justify-between">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure your billing settings, payment methods, and invoice preferences.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="next-number" type="number" placeholder="1001" defaultValue="1001" />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="payment-terms">Payment Terms (days)</Label>
                  <Input id="payment-terms" type="number" placeholder="30" defaultValue="30" />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input id="tax-rate" type="number" placeholder="8.5" defaultValue="8.5" />
                  </div>
                  <div className="space-y-2">
              ...
              <Button className="w-full md:w-auto">Save Billing Settings</Button>
            </CardContent>
          </Card>
            )}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">iOS App • San Francisco, CA</p>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Download all your practice data</p>
                    </div>
