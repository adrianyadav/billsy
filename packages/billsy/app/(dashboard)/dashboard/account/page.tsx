...
export default function MBSPage() {
  ...
  const categories = [
    ...
    { name: "Procedures", items: 1, usage: 3, avgFee: 156.3 },
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Breakdown of MBS usage by service category
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Search and manage your MBS item codes
              </CardDescription>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="Health Assessments">
                  Health Assessments
                </SelectItem>
