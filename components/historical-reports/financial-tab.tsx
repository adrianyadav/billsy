...
const financialData = {
  ...
  paymentTypes: [
    ...
    { type: "Private", amount: 125300.5, percentage: 29.6, color: "#10b981" },
    { type: "DVA", amount: 87500.0, percentage: 20.7, color: "#8b5cf6" },
    {
      type: "Workers Comp",
      amount: 24900.0,
      percentage: 5.9,
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              Total Billings (Service Date)
            </CardTitle>
            <IconCalendar className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(financialData.totalBillings.byServiceDate)}
            </div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              Total Billings (Created Date)
            </CardTitle>
            <IconCalendar className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(financialData.totalBillings.byCreatedDate)}
            </div>
            <p className="text-xs text-muted-foreground flex items-center gap-1">
              <IconTrendingUp className="h-3 w-3" />+
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              Total Payments (Paid Date)
            </CardTitle>
            <IconCurrencyDollar className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(financialData.totalPayments.byPaidDate)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(financialData.billingsPerAppointment.amount)}
            </div>
            <p className="text-xs text-muted-foreground flex items-center gap-1">
              <IconTrendingUp className="h-3 w-3" />
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold">
                    {financialData.keyPerformanceRatios.bulkBillingPercentage}%
                  </span>
                </div>
                <Progress
                  value={
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold">
                    {financialData.keyPerformanceRatios.medicarePercentage}%
                  </span>
                </div>
                <Progress
                  value={financialData.keyPerformanceRatios.medicarePercentage}
                  className="h-2"
                />
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold">
                    {financialData.keyPerformanceRatios.nonMedicarePercentage}%
                  </span>
                </div>
                <Progress
                  value={
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold">
                    {financialData.keyPerformanceRatios.cdmBillingsPercentage}%
                  </span>
                </div>
                <Progress
                  value={
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold">
                    {formatCurrency(
                      financialData.keyPerformanceRatios.telehealthBillings,
                    )}{" "}
                    ({financialData.keyPerformanceRatios.telehealthPercentage}%)
                  </span>
                </div>
                <Progress
                  value={
